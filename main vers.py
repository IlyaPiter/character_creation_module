...
def attack(char_name, char_class):
    nanesuron = ' нанёс урон противнику равный '
    if char_class == 'warrior':
        return (f'{char_name}{nanesuron}{5 + randint(3, 5)}')
    if char_class == 'mage':
        return (f'{char_name}{nanesuron}{5 + randint(5, 10)}')
    if char_class == 'healer':
        return (f'{char_name}{nanesuron}{5 + randint(-3, -1)}')
...
def special(char_name, char_class):
    primenilspec = ' применил специальное умение '
    if char_class == 'warrior':
        return (f'{char_name}{primenilspec}«Выносливость {80 + 25}»')
    if char_class == 'mage':
        return (f'{char_name}{primenilspec}«Атака {5 + 40}»')
    if char_class == 'healer':
        return (f'{char_name}{primenilspec}«Защита {10 + 30}»')
